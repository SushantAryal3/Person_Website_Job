...
const Experience = () => {
  ...
  const rawGlobeY = useTransform(scrollYProgress, (progress) => progress * travel);
  const globeY = useSpring(rawGlobeY, { stiffness: 200, damping: 30, mass: 0.4 });
