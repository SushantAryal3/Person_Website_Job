      ...
      <div className="w-[90vw] max-w-[80vw] mx-auto pt-5 md:pt-10 relative z-10">
        ...
        <div className="flex flex-col gap-6 md:grid md:grid-cols-[22%_1fr] md:gap-0">
          ...
          <div className=" text-lg relative bg-[#f2e9e4] text-gray-700 leading-relaxed space-y-4 md:text-2xl md:pl-6 py-2 -my-2">
            <p>
              I'm a geospatial engineer with an MSc in Geo-Information Science and Earth Observation,
              completed jointly between the University of Tartu and UCLouvain, and a background in geomatics engineering. 
            ...
            <p>
              I build end-to-end geospatial systems: pipelines that turn satellite and sensor data into deep-learning-ready inputs,
              spatial analysis and databases that serve decision-ready data at scale, and web maps that put it in front of decision-makers.
              From PyTorch models and PostGIS spatial queries to React/Next front ends and containerised deployments, covering the
              pipeline end to end.
            </p>
          </div>
        </div>
