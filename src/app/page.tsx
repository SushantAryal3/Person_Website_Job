  ...
  return (
    <>
      ...
      >
        ...
        />
        <a
          href="https://www.vecteezy.com/free-videos/gis"
          target="_blank"
          rel="noopener noreferrer"
          className="absolute bottom-2 left-2 z-[5] text-[10px] text-white/40 hover:text-white/70 transition-colors"
        >
          Gis Stock Videos by Vecteezy
        </a>
        <div
      ...
      />
        ...
        <motion.div
          className="absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:left-auto md:translate-x-0 md:top-auto md:translate-y-0 md:bottom-[10vh] md:right-[8%]"
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute left-1/2 -translate-x-1/2 top-[70%] sm:left-[14%] sm:translate-x-0 sm:top-[53%] md:top-[53%] md:left-[18%] lg:left-[6%] lg:top-[54%] xl:left-[15%] xl:top-[55%] xxl:left-[18%] xxl:top-[55%] overflow-hidden">
            <motion.h1
            ...
            >
              Geospatial <br className="hidden sm:inline" />
              ML Engineer
            </motion.h1>
          </div>
          <div className="absolute left-1/2 -translate-x-1/2 top-[83%] sm:left-auto sm:translate-x-0 sm:top-[34%] sm:right-[12%] md:top-[35%] md:right-[17%] lg:top-[30%] lg:right-[4%] xl:top-[30%] xl:right-[11%] xxl:right-[20%] xxl:top-[30%] overflow-hidden">
            <motion.h1
              className="text-4xl sm:text-4xl lg:text-7xl font-medium text-white leading-none"
              initial={{ y: "110%" }}
              animate={{ y: 0 }}
